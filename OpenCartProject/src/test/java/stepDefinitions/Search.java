...
public class Search {
	...
	private SearchResultsPage seachResultsPage;
	...
	public void user_should_get_valid_product_displayed_in_search_results() {
		...
		seachResultsPage = new SearchResultsPage(driver);
		seachResultsPage.displayStatusOfValidProduct();
	...
	public void user_should_get_a_message_about_no_product_matching() {
		...
		seachResultsPage = new SearchResultsPage(driver);
		Assert.assertEquals("There is no product that matches the search criteria.", seachResultsPage.getMessageText());
	}
